...
export const generate = (): ScriptData => ({
  scripts: {
    ...
    inlineHashes: [
      -1746719145, -1110312912, -815800953, -314038750, -211036372, 216868775, 1424856663,
      288533800, 318224283, -362024285, 585973559, 4606827, -1611905557, 1800521327, 2118020403,
      1532181211, -1957835502, -222105570, -1616636591,
    ],
    elapsed: 8,
    dynamicUrlCount: 11,
